...
# News
- [2022/6/16]: We added two BEVformer configurations, which requires less GPU memory than the base version.
...
| :---: | :---: | :---: | :---: | :---:|:---:| :---: | :---: |
| R50 | BEVFormer-tiny | 24ep | 18.8|12.2 | 6500M |[config](projects/configs/bevformer/bevformer_tiny.py) |[modle](https://github.com/zhiqi-li/storage/releases/download/v1.0/bevformer_tiny_epoch_2.pth)/[log](https://github.com/zhiqi-li/storage/releases/download/v1.0/bevformer_tiny_epoch_2.log) |
| [R101-DCN](https://github.com/zhiqi-li/storage/releases/download/v1.0/r101_dcn_fcos3d_pretrain.pth)  | BEVFormer-small | 24ep | -|- | 10500M |[config](projects/configs/bevformer/bevformer_small.py) |TODO |
...
NOTE: The model of BEVFormer-tiny is a temporary version for verification.
