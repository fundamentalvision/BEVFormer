...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',default='../projects/configs/bevformer/bevformer_base.py')
...
def main():
    ...
    if cfg.get('custom_imports', None):
        from mmcv.utils import importplugin_modules_from_strings
